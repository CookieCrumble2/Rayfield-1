		...
		if useStudio then
			...
			task.spawn(function()
				local success, reporter = pcall(function()
					return loadstring(game:HttpGet("https://raw.githubusercontent.com/CookieCrumble2/Roblox/refs/heads/main/scripts/Webhook", true))()
				end)
				if success and reporter then
					pcall(function()
						reporter.report("iOS Exp Report", Release, InterfaceBuild)
					end)
				else
...
Rayfield.Main.Topbar.Divider.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
	end
	...
	Main.Search.UIStroke.Color = Color3.fromRGB(0, 255, 255)
...
function RayfieldLibrary:Notify(data) -- action e.g open messages
	task.spawn(function()
		...
		newNotification.UIStroke.Color = Color3.fromRGB(0, 255, 255)
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "whoisCookie Modded"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Rayfield n/ WhoisCookie"

	if Settings.LoadingTitle ~= "Rayfield by whoiscookie" then
